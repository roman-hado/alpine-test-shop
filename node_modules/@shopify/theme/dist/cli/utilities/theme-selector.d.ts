...
export declare function findOrSelectTheme(session: AdminSession, options: {
    header: string;
    filter: FilterProps;
}): Promise<import("../models/theme.js").Theme>;
/**
 ...
 */
export declare function findThemes(session: AdminSession, filterProps: FilterProps): Promise<import("../models/theme.js").Theme[]>;
